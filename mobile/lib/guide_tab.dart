...
Widget _gardenPage(BuildContext context) {
  ...
  return docPage(context, [
    ...
    para('Whether your garden can grow enough Law Fruit to hit the '
        ...
        'get back. ([[ref:systems#garden|Reference → World Systems]] '
        'covers the basics this page builds on.)'),
    para('The less money you spend, the more this matters. Free '
        ...
        'have the Pot, having every cell unlocked matters even more.'),
    ...
    para('Don\'t put the whole grid into Law Fruit. Your seed supply '
        'limits how much Law Fruit you can actually use (more below), '
        'so a handful of Law Fruit slots is enough. Here\'s a layout '
        'that fills every one of the 36 cells with nothing left over: '
        '6 Law Fruit (3 cells each) + 3 gear-crafting (4 cells each) '
        '+ 2 Ploughwood (3 cells each) = 36:'),
    ...
    para('6 Law Fruit is enough to hit the daily Blitz cap. 3 '
        ...
        'clean 1-for-1 swap.'),
    Text('Speeding up growth: watering, and the Pot if you have it',
        style: h3),
    para('You get **1 free watering a day** from the garden itself. '
        ...
        'one plant at a time. That\'s only 6 hours a day even with the '
        'bonus, nowhere near enough to cover a 40-hour Purple grow on '
        'its own. A few other free things help close the gap:\n'
        ...
        'unlock them.\n'
        '• **Pets give you some free time-skip every day** too, though '
        'the amount varies, so don\'t count on a fixed number.'),
    para('**If you have the Pot Creation Artifact**, it changes the '
        'picture: Pot spends energy to speed up growth, 1 energy = 1 '
        'hour off, on any crop including Law Fruit. It\'s the only way '
        'to speed up growth beyond watering, and a well-fed Pot skips '
        'a lot of grow time every day on top of that. Pot energy also '
        'lets the gear-crafting crop grow up to Yellow instead of '
        'stopping at Purple, but that doesn\'t carry over to Law '
        'Fruit — its top tier is fixed no matter how much Pot energy '
        'you use (you still need Shears for Red, below).'),
    para('**If you don\'t have the Pot**, don\'t worry about it for '
        ...
        'math below), so the recommended layout doesn\'t change '
        'either way. Where the Pot actually helps is filling out the '
        'rest of the day\'s Blitz cap and speeding up the '
        'gear-crafting crop.'),
    ...
    para('**Grow Purple by default.** At 6 Blitz-hours per seed, your '
        '20 seeds a week add up to **120 Blitz-hours** total, roughly '
        '17 a day if you spread it evenly. That\'s well under the '
        '120-hour daily cap, so seeds run out long before the cap '
        'does. Having the Pot doesn\'t change this: it lets you '
        'finish each Purple grow faster and harvest in bursts instead '
        'of a steady trickle, but it can\'t stretch 20 seeds into more '
        'than 20 seeds. For comparison, a garden growing nothing but '
        'Green Law Fruit could put out far more on paper — about 72 a '
        'day for a fully dedicated 12-slot garden with no Pot at all, '
        'or up to roughly 108 a day with a well-invested Pot. Purple '
        'still wins because seeds are what you\'re short on, not '
        'hours.'),
    para('Only grow Green as a top-off, once Purple has already '
        ...
        'that\'s all that matters once seeds are your real limit.'),
    para('**In practice:** about 6 Law Fruit plants growing Purple is '
        'enough to use your whole weekly seed supply, Pot or no Pot, '
        'which is why the layout above doesn\'t need more than that. '
        'Extra slots do more good on the gear-crafting crop or '
    ...
    para('Even a perfect garden usually can\'t fill the daily Blitz '
        ...
        'the rest of your daily cap, since the garden alone can\'t '
        'get there unless you pay, or unless a strong Pot is doing a '
        'lot of the work for you.'),
    Text('Red tier: the other artifact', style: h3),
    para('One more Creation Artifact touches the garden, easy to mix '
        'up with the Pot above: **Shears** pushes an already-grown '
        'fruit up to Red tier. Red doesn\'t grow on its own — Shears '
        'is the only way to get it. Its 14-hour Blitz value **doesn\'t '
        'count against the 120-hour/day cap**, so it\'s pure bonus on '
        'top of your Purple total, Pot or no Pot. Full detail on both '
        'artifacts is in [[ref:artifacts|Reference → Artifacts & '
        'Gems]].'),
    Text('Spending fruit: how to level up your Laws', style: h3),
    para('**Blitz** turns one fruit into hours of progress at whatever '
        'your current Learning Speed is for that element, not a fixed '
        'number of Law Points. Use it on whichever of the five '
        ...
        'is worth more Law Points later. But leveling early gets your '
        'speed up sooner, and that pays off on every fruit you blitz '
        'after it. Spending as you go beats saving it all for later.\n'
