...
const Map<String, Map<String, String>> _t = {
  ...
  'Target stage precedes current stage.': {
    'ru': 'Целевая стадия раньше текущей.',
    'de': 'Zielstufe liegt vor der aktuellen Stufe.',
    'es': 'La etapa objetivo es anterior a la actual.',
    'zh': '目标阶段早于当前阶段。',
  },
