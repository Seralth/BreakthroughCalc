...
TRANSLATIONS = {
 "ru": {
  ...
  "Sources": "Источники",
  "Vault": "Хранилище",
  "Search the Vault…": "Поиск по Хранилищу…",
  "Advisor": "Советник",
  "What to work on next, priced in days saved on your current projection. The plan lists steps you can simply go do; curios come from random draws, so those rank separately as what a lucky pull would be worth.": "Что качать дальше — в днях, сэкономленных на текущем прогнозе. В плане — шаги, которые можно просто пойти и сделать; диковинки выпадают из случайных розыгрышей, поэтому они ранжируются отдельно — как ценность удачной выпадки.",
  "Source": "Источник",
  "Next step": "Следующий шаг",
  "Time saved": "Экономия времени",
  "Bonuses the calculator does not model — combat stats, Spiritium, Abode Aura already inside your readings — are not ranked.": "Бонусы, которые калькулятор не моделирует — боевые характеристики, Спиритий, аура обители, уже входящая в ваши показания, — не ранжируются.",
  "Rank again": "Пересчитать",
  "Fill in the Calculator first — the advisor prices improvements against your current projection.": "Сначала заполните Калькулятор — советник оценивает улучшения относительно текущего прогноза.",
  "Ranking: days until your target Stage.": "Ранжирование: дни до целевой Стадии.",
  "Ranking: days to finish the current Stage.": "Ранжирование: дни до конца текущей Стадии.",
  "Plan — level or learn next": "План — что качать или изучать дальше",
  "Random draws — worth pulling for": "Случайные розыгрыши — ради чего стоит крутить",
  "Nothing here helps right now.": "Сейчас здесь ничто не поможет.",
  "Own": "Получить",
 ...
 "de": {
  ...
  "Sources": "Quellen",
  "Vault": "Tresor",
  "Search the Vault…": "Tresor durchsuchen…",
  "Advisor": "Berater",
  "What to work on next, priced in days saved on your current projection. The plan lists steps you can simply go do; curios come from random draws, so those rank separately as what a lucky pull would be worth.": "Woran als Nächstes arbeiten — bepreist in Tagen, die deine aktuelle Prognose spart. Der Plan listet Schritte, die du einfach angehen kannst; Kuriositäten kommen aus Zufallsziehungen und werden separat gereiht — als Wert eines Glückszugs.",
  "Source": "Quelle",
  "Next step": "Nächster Schritt",
  "Time saved": "Zeitersparnis",
  "Bonuses the calculator does not model — combat stats, Spiritium, Abode Aura already inside your readings — are not ranked.": "Boni, die der Rechner nicht modelliert — Kampfwerte, Spiritium, Refugium-Aura, die bereits in deinen Werten steckt — werden nicht gereiht.",
  "Rank again": "Neu berechnen",
  "Fill in the Calculator first — the advisor prices improvements against your current projection.": "Fülle zuerst den Rechner aus — der Berater bewertet Verbesserungen gegen deine aktuelle Prognose.",
  "Ranking: days until your target Stage.": "Reihung: Tage bis zur Ziel-Stufe.",
  "Ranking: days to finish the current Stage.": "Reihung: Tage bis zum Ende der aktuellen Stufe.",
  "Plan — level or learn next": "Plan — als Nächstes leveln oder lernen",
  "Random draws — worth pulling for": "Zufallsziehungen — wofür sich Ziehen lohnt",
  "Nothing here helps right now.": "Hier hilft gerade nichts.",
  "Own": "Besitzen",
 ...
 "es": {
  ...
  "Sources": "Fuentes",
  "Vault": "Bóveda",
  "Search the Vault…": "Buscar en la Bóveda…",
  "Advisor": "Asesor",
  "What to work on next, priced in days saved on your current projection. The plan lists steps you can simply go do; curios come from random draws, so those rank separately as what a lucky pull would be worth.": "En qué trabajar ahora, valorado en días ahorrados sobre tu proyección actual. El plan lista pasos que puedes simplemente ir a hacer; las curiosidades salen de sorteos aleatorios, así que se clasifican aparte — como el valor de una tirada afortunada.",
  "Source": "Fuente",
  "Next step": "Siguiente paso",
  "Time saved": "Tiempo ahorrado",
  "Bonuses the calculator does not model — combat stats, Spiritium, Abode Aura already inside your readings — are not ranked.": "Los bonos que la calculadora no modela — estadísticas de combate, Spiritium, el aura de morada ya incluida en tus lecturas — no se clasifican.",
  "Rank again": "Recalcular",
  "Fill in the Calculator first — the advisor prices improvements against your current projection.": "Rellena primero la Calculadora — el asesor valora mejoras contra tu proyección actual.",
  "Ranking: days until your target Stage.": "Clasificación: días hasta tu Etapa objetivo.",
  "Ranking: days to finish the current Stage.": "Clasificación: días para terminar la Etapa actual.",
  "Plan — level or learn next": "Plan — subir o aprender ahora",
  "Random draws — worth pulling for": "Sorteos aleatorios — por qué vale la pena tirar",
  "Nothing here helps right now.": "Nada de aquí ayuda ahora mismo.",
  "Own": "Obtener",
 ...
 "zh": {
  ...
  "Sources": "来源",
  "Vault": "宝库",
  "Search the Vault…": "搜索宝库…",
  "Advisor": "顾问",
  "What to work on next, priced in days saved on your current projection. The plan lists steps you can simply go do; curios come from random draws, so those rank separately as what a lucky pull would be worth.": "接下来该练什么——以当前推算节省的天数计价。计划列出可以直接去做的步骤；珍宝来自随机抽取，因此单独排序——按抽中一件的价值计算。",
  "Source": "来源",
  "Next step": "下一步",
  "Time saved": "节省时间",
  "Bonuses the calculator does not model — combat stats, Spiritium, Abode Aura already inside your readings — are not ranked.": "计算器未建模的加成——战斗属性、灵石收益、已包含在读数中的洞府灵气——不参与排序。",
  "Rank again": "重新排序",
  "Fill in the Calculator first — the advisor prices improvements against your current projection.": "请先填写计算器——顾问基于当前推算为改进定价。",
  "Ranking: days until your target Stage.": "排序依据：距目标阶段的天数。",
  "Ranking: days to finish the current Stage.": "排序依据：完成当前阶段的天数。",
  "Plan — level or learn next": "计划——接下来升级或学习",
  "Random draws — worth pulling for": "随机抽取——值得抽的目标",
  "Nothing here helps right now.": "目前这里没有能帮上忙的。",
  "Own": "获得",
  "Max shelf": "整层拉满",
  "Elixirs": "灵液",
