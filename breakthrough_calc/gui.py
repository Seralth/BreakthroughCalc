...
class MainWindow(QMainWindow):
    ...
    def _build_info_tab(self) -> QWidget:
        ...
        combat += (
            ...
            "<p>Crits work the way you'd guess: <b>Crit Chance</b> to trigger one "
            "(there's a cap that rises with level), <b>Crit DMG</b> for how hard it "
            "hits, and <b>Crit Defense / Resistance</b> to blunt enemy crits. "
            "You'll also see PvP-only lines like \"DMG dealt to Taoists +x%\" — "
            ...
            "purple → orange. When an item is forged its stats roll within a "
            ...
            "<li><b>Resonance:</b> a team-wide bonus that looks at the level of "
            "your <i>lowest</i> equipped piece. Push everything past the next "
