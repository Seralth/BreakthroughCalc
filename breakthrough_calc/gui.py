...
class MainWindow(QMainWindow):
    ...
    def _build_info_tab(self) -> QWidget:
        ...
        advanced += (
            ...
            "(verified in-game 2026-07-10: a random gush on the 5th fruit reset "
            "the counter to 6). So a gush is guaranteed within 6 fruits of the "
            "last one, not on every literal 6th. The calculator models this as "
