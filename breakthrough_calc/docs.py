...
def build_guide_pages(acc: dict) -> list:
    ...
    timegate = (
        ...
        "overcap percentage translates directly into future progress.</li>"
        "</ul>"
        ...
        "path), which is what makes the secondary rush below possible.</li>"
        "<li><b>Perfection</b> — primary at Incarnation (Perfected), "
        "secondary at Nascent Soul Late, clear Amethyst Fiend in Myrimon "
        "Wonder: <b>+20 points</b> absorption.</li>"
        "<li><b>Perfect</b> — secondary at Incarnation Middle, clear "
        "Jade-Eyed Lion: a further <b>+20 points</b> permanent, plus "
        "<b>+20 points active only before Voidbreak Middle</b>.</li></ul>"
        "<p>Secondary requirements are satisfied on <b>reaching</b> the "
        "named half-step, not completing it. Fully built: +40 points "
        "permanent, +60 total until you enter Voidbreak Middle — on a 0.40 "
        "base band that is more than double the parked passive rate. The "
        "windowed +20 ends the instant you enter Voidbreak Middle, which "
        "drives the gate-day routing below.</p>"
        ...
        "parked accrual. Clear the two Myrimon Wonder bosses ahead of time "
        "so they never hold a tier hostage.</li>"
        ...
        "current Strive number.</b> Parked at the Early cap you accrue at "
        "(0.50 + 0.60 blessing) with no Strive; live in Middle you accrue "
        "at (0.65 + 0.40) × (1 + Strive). Strive is measured against the "
        "server's top cultivator, so what matters is the Strive you would "
        "have <i>while in Middle</i>:"
        "<ul><li><b>Never be the first into Middle.</b> While the leaders "
        "hold the Early cap, pushing past them makes you the front — your "
        "Strive drops away and you grind Middle at a flat 1.05, worse than "
        "parking at 1.10.</li>"
        ...
        "their Strive while climbing Middle live. Above ~5% Strive, pushing "
        "now beats staying parked; below it, keep parking until your own "
        "pool covers the rest.</li></ul>"
        "The net effect: the server bunches at the Early cap, then peels "
        "off front to back.</li>"
